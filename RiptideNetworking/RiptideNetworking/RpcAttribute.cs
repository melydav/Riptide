...
namespace Riptide
{
    ...
    /// <remarks>To get parameters from an RPC call, use <see cref="Message.GetObjects"/> method with an array of types, so the right amount of bits can be retrieved.</remarks>
